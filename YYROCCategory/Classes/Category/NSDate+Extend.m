...
+ (NSCalendar *)clsCalendar {
    return [[self alloc] yyr_calendar];
}

- (NSCalendar *)yyr_calendar {
...
- (NSInteger)year {
    return [[[self yyr_calendar] components:NSCalendarUnitYear fromDate:self] year];
}

- (NSInteger)month {
    return [[[self yyr_calendar] components:NSCalendarUnitMonth fromDate:self] month];
}

- (NSInteger)day {
    return [[[self yyr_calendar] components:NSCalendarUnitDay fromDate:self] day];
}

- (NSInteger)hour {
    return [[[self yyr_calendar] components:NSCalendarUnitHour fromDate:self] hour];
}

- (NSInteger)minute {
    return [[[self yyr_calendar] components:NSCalendarUnitMinute fromDate:self] minute];
}

- (NSInteger)second {
    return [[[self yyr_calendar] components:NSCalendarUnitSecond fromDate:self] second];
}

- (NSInteger)weekday {
    return [[[self yyr_calendar] components:NSCalendarUnitWeekday fromDate:self] weekday];
}
...
+ (NSInteger)getCurrentMonthForDay {
